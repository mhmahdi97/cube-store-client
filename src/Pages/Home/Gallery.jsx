    ...
    return (
        <section className="text-gray-600 body-font mt-14">
            ...
            <div className="container px-5 py-14 mx-auto flex flex-wrap">
                ...
                <div data-aos="fade-right" className="flex flex-wrap w-full bg-gray-100 py-32 px-10 relative mb-4">
                ...
                <div className="flex flex-wrap -mx-2">
                    ...
                    <div data-aos="fade-right" className="flex flex-wrap w-full bg-gray-100 sm:py-24 py-16 sm:px-10 px-6 relative">
                    ...
                    <div className="px-2 w-1/2">
                    <div data-aos="fade-left" className="flex flex-wrap w-full bg-gray-100 sm:py-24 py-16 sm:px-10 px-6 relative">
